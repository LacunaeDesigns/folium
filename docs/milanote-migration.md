...
offers PDF, PNG, Word, Markdown and plain text only. AtlasNote supports two
migration paths.
...
an AtlasNote backup file, and you import it via Export → Import backup.
